...
function processTrigger(msg, cfg) {
  ...
  snazzy.createSession(cfg, () => {
    ...
    let uri = `http://snazzycontacts.com/mp_contact/json_respond/address_contactperson/json_mainview?address_contactperson_search=${cfg.search}&mp_cookie=${cfg.mp_cookie}`;
